...
- **Фиксированный приоритет сети Low** — самый дешёвый вариант комиссии, который принимает Monero; выбора
  приоритета в интерфейсе нет, чтобы не гадать, сколько он стоит.
